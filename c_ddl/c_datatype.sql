...
# INSERT 키워드: 데이터 '삽입'
# INSERT INTO 테이블면 VALUE (레코드값을 컬럼 순으로 콤마로 구분하여 나열);
INSERT INTO `integer`
VALUE (127, 32767, 2000000000, 90000000000000000);

-- INSERT INTO `integer`
-- VALUE (128, 32767, 2000000000, 90000000000000000);
# Out of range value for column 't_col' at row 1
...
VALUE('Laptop Samsung Book 3 Pro', '전자제품', '삼성 갤럭시 북3 노트북 프로입니다. 아주 좋아요', 'example');
...
CREATE TABLE product (
    ...
    price1 float(7, 2), 
    -- price1 float (권장)
    price2 double(10, 4), -- float, double의 형태로만 사용 권장
    -- price2 double (권장)
    price3 decimal(15, 2) -- decimal은 실제 자리수 사용 권장
);

insert into product
VALUE (12345.67, 123456,7890, 12345678912.99);

/*
	4. 논리형
    : boolean ㄱ밧을 저장히기 위한 데이터 타입
...
INSERT INTO employee VALUE(true);
