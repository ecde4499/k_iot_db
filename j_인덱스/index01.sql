...
# - 테이블 당 여러개 생성 가능
# - 자동 정렬 기능 포함 X
# Ex) 일반 서적: 색인(찾아보기) 등의 페이저 번호를 보고 해당 위치로 이동해야 내용 확인 가능
...
SELECT * FROM members; -- 인덱스 저장 후 (P K설정 후) 추가 데이터 삽입 시: 정렬 기준에 따라 자동 정렬

-- 정렬되지 않는 보조 인덱스 --
# : 고유 키 지정 시 생성 / 테이블 당 여러개 가능 / 정렬 X
