...
begin
    ...
    begin
			-- 예외 발생 시 롤백
			rollback;
			select '트랜잭션 롤백: 오류 발생 변경이 취소되었습니다.' as message;
	end;
...
create table transaction_log (
    ...
    to_account_id int,
    amount int,
    tansaction_date datetime default current_timestamp, # 현재 날짜와 로컬 시간을 반환
